...
import { i as isTouchCapable, d as isMobileDevice, e as cleanValue, f as scrollIntoView, h as classNames, n as noop, j as isDocumentElement } from './utils-711604ed.esm.js';
import { c as clearIndicatorCSS, a as containerCSS, b as css, d as dropdownIndicatorCSS, g as groupCSS, e as groupHeadingCSS, i as indicatorsContainerCSS, f as indicatorSeparatorCSS, h as inputCSS, l as loadingIndicatorCSS, j as loadingMessageCSS, m as menuCSS, k as menuListCSS, n as menuPortalCSS, o as multiValueCSS, p as multiValueLabelCSS, q as multiValueRemoveCSS, r as noOptionsMessageCSS, s as optionCSS, t as placeholderCSS, u as css$1, v as valueContainerCSS, M as MenuPlacer, w as defaultComponents, x as exportedEqual } from './index-52626178.esm.js';
...
function mergeStyles(source, target) {
  ...
  var styles = _extends$2({}, source); // massage in target styles
...
function (_Component) {
  ...
  function Select(_props) {
    ...
    _this.onChange = function (newValue, actionMeta) {
      ...
      onChange(newValue, _extends$3({}, actionMeta, {
        name: name
      }));
    };
  ...
  _proto.getTheme = function getTheme() {
    ...
    return _extends$3({}, defaultTheme, this.props.theme);
  };
  ...
  _proto.renderInput = function renderInput() {
    var _this$props13 = this.props,
        ...
        isSearchable = _this$props13.isSearchable,
    ...
    if (!isSearchable) {
      ...
      return React.createElement(DummyInput, _extends$3({
        id: id,
  ...
  _proto.renderPlaceholderOrValue = function renderPlaceholderOrValue() {
    ...
    var _this$props14 = this.props,
        controlShouldRenderValue = _this$props14.controlShouldRenderValue,
    ...
    var _this$state7 = this.state,
        ...
        isFocused = _this$state7.isFocused;

    if (!this.hasValue() || !controlShouldRenderValue) {
      return inputValue ? null : React.createElement(Placeholder, _extends$3({}, commonProps, {
        key: "placeholder",
        isDisabled: isDisabled,
        isFocused: isFocused
      }), placeholder);
    ...
    if (isMulti) {
      var selectValues = selectValue.map(function (opt, index) {
        ...
        return React.createElement(MultiValue, _extends$3({}, commonProps, {
          components: {
    ...
    return React.createElement(SingleValue, _extends$3({}, commonProps, {
      data: singleValue,
      isDisabled: isDisabled
  ...
  _proto.renderClearIndicator = function renderClearIndicator() {
    ...
    return React.createElement(ClearIndicator, _extends$3({}, commonProps, {
  ...
  _proto.renderLoadingIndicator = function renderLoadingIndicator() {
    ...
    return React.createElement(LoadingIndicator, _extends$3({}, commonProps, {
      innerProps: innerProps,
      isDisabled: isDisabled,
      isFocused: isFocused
    }));
  ...
  _proto.renderIndicatorSeparator = function renderIndicatorSeparator() {
    ...
    var isFocused = this.state.isFocused;
    return React.createElement(IndicatorSeparator, _extends$3({}, commonProps, {
      isDisabled: isDisabled,
      isFocused: isFocused
    }));
  };
  ...
  _proto.renderDropdownIndicator = function renderDropdownIndicator() {
    ...
    return React.createElement(DropdownIndicator, _extends$3({}, commonProps, {
      innerProps: innerProps,
      isDisabled: isDisabled,
      isFocused: isFocused
    }));
  ...
  _proto.renderMenu = function renderMenu() {
    ...
    var _this$state8 = this.state,
        focusedOption = _this$state8.focusedOption,
        menuOptions = _this$state8.menuOptions;
    var _this$props17 = this.props,
        captureMenuScroll = _this$props17.captureMenuScroll,
        inputValue = _this$props17.inputValue,
        isLoading = _this$props17.isLoading,
        loadingMessage = _this$props17.loadingMessage,
        minMenuHeight = _this$props17.minMenuHeight,
        maxMenuHeight = _this$props17.maxMenuHeight,
        menuIsOpen = _this$props17.menuIsOpen,
        menuPlacement = _this$props17.menuPlacement,
        menuPosition = _this$props17.menuPosition,
        menuPortalTarget = _this$props17.menuPortalTarget,
        menuShouldBlockScroll = _this$props17.menuShouldBlockScroll,
        menuShouldScrollIntoView = _this$props17.menuShouldScrollIntoView,
        noOptionsMessage = _this$props17.noOptionsMessage,
        onMenuScrollToTop = _this$props17.onMenuScrollToTop,
        onMenuScrollToBottom = _this$props17.onMenuScrollToBottom;
    ...
    var render = function render(props) {
      ...
      return React.createElement(Option, _extends$3({}, commonProps, props, {
        isFocused: isFocused
    ...
    if (this.hasOptions()) {
      menuUI = menuOptions.render.map(function (item) {
        if (item.type === 'group') {
          ...
          return React.createElement(Group, _extends$3({}, commonProps, group, {
    ...
    var menuElement = React.createElement(MenuPlacer, _extends$3({}, commonProps, menuPlacementProps), function (_ref6) {
      var ref = _ref6.ref,
          _ref6$placerProps = _ref6.placerProps,
          placement = _ref6$placerProps.placement,
          maxHeight = _ref6$placerProps.maxHeight;
      return React.createElement(Menu, _extends$3({}, commonProps, menuPlacementProps, {
        innerRef: ref,
        innerProps: {
      ...
      }, React.createElement(MenuList, _extends$3({}, commonProps, {
    ...
    return menuPortalTarget || menuPosition === 'fixed' ? React.createElement(MenuPortal, _extends$3({}, commonProps, {
  ...
  _proto.renderFormField = function renderFormField() {
    ...
    var _this$props18 = this.props,
        delimiter = _this$props18.delimiter,
        isDisabled = _this$props18.isDisabled,
        isMulti = _this$props18.isMulti,
  ...
  _proto.render = function render() {
    ...
    var _this$props19 = this.props,
        ...
        menuIsOpen = _this$props19.menuIsOpen;
    var isFocused = this.state.isFocused;
    var commonProps = this.commonProps = this.getCommonProps();
    return React.createElement(SelectContainer, _extends$3({}, commonProps, {
      className: className,
      innerProps: {
        id: id,
      ...
      isDisabled: isDisabled,
      isFocused: isFocused
    }), React.createElement(Control, _extends$3({}, commonProps, {
    ...
    }), React.createElement(ValueContainer, _extends$3({}, commonProps, {
      isDisabled: isDisabled
    }), this.renderPlaceholderOrValue(), this.renderInput()), React.createElement(IndicatorsContainer, _extends$3({}, commonProps, {
      isDisabled: isDisabled
