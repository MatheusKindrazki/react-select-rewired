...
function DummyInput(_ref) {
  ...
  return core.jsx("input", _extends$1({
    ref: innerRef
  }, props, {
    css: _css({
      label: "dummyInput",
...
var defaultProps = {
  ...
  function Select(_props) {
    ...
    _this.controlRef = null, _this.getControlRef = function(ref) {
      ...
      (0, _this$props.onChange)(newValue, _extends$3({}, actionMeta, {
      ...
      _this.setState({
        ariaLiveContext: instructionsAriaMessage(event, _extends$3({}, context, {
  ...
  return _proto.componentDidMount = function() {
    ...
    return this.props.theme ? "function" == typeof this.props.theme ? this.props.theme(defaultTheme) : _extends$3({}, defaultTheme, this.props.theme) : defaultTheme;
    ...
    var _this$props13 = this.props, isDisabled = _this$props13.isDisabled, isSearchable = _this$props13.isSearchable, inputId = _this$props13.inputId, inputValue = _this$props13.inputValue, tabIndex = _this$props13.tabIndex, Input = this.components.Input, inputIsHidden = this.state.inputIsHidden, id = inputId || this.getElementId("input"), ariaAttributes = {
      "aria-autocomplete": "list",
      "aria-label": this.props["aria-label"],
      "aria-labelledby": this.props["aria-labelledby"]
    };
    if (!isSearchable) return React__default.createElement(DummyInput, _extends$3({
      id: id,
    ...
    return React__default.createElement(Input, _extends$3({
      autoCapitalize: "none",
      autoComplete: "off",
      autoCorrect: "off",
      cx: cx,
    ...
    var _this4 = this, _this$components = this.components, MultiValue = _this$components.MultiValue, MultiValueContainer = _this$components.MultiValueContainer, MultiValueLabel = _this$components.MultiValueLabel, MultiValueRemove = _this$components.MultiValueRemove, SingleValue = _this$components.SingleValue, Placeholder = _this$components.Placeholder, commonProps = this.commonProps, _this$props14 = this.props, controlShouldRenderValue = _this$props14.controlShouldRenderValue, isDisabled = _this$props14.isDisabled, isMulti = _this$props14.isMulti, inputValue = _this$props14.inputValue, placeholder = _this$props14.placeholder, _this$state7 = this.state, selectValue = _this$state7.selectValue, focusedValue = _this$state7.focusedValue, isFocused = _this$state7.isFocused;
    if (!this.hasValue() || !controlShouldRenderValue) return inputValue ? null : React__default.createElement(Placeholder, _extends$3({}, commonProps, {
      key: "placeholder",
      isDisabled: isDisabled,
      isFocused: isFocused
    }), placeholder);
    if (isMulti) return selectValue.map((function(opt, index) {
      ...
      return React__default.createElement(MultiValue, _extends$3({}, commonProps, {
        components: {
    ...
    return React__default.createElement(SingleValue, _extends$3({}, commonProps, {
      data: singleValue,
      isDisabled: isDisabled
    }), this.formatOptionLabel(singleValue, "value"));
  }, _proto.renderClearIndicator = function() {
    var ClearIndicator = this.components.ClearIndicator, commonProps = this.commonProps, _this$props15 = this.props, isDisabled = _this$props15.isDisabled, isLoading = _this$props15.isLoading, isFocused = this.state.isFocused;
    ...
    return React__default.createElement(ClearIndicator, _extends$3({}, commonProps, {
      innerProps: innerProps,
      isFocused: isFocused
    }));
  }, _proto.renderLoadingIndicator = function() {
    var LoadingIndicator = this.components.LoadingIndicator, commonProps = this.commonProps, _this$props16 = this.props, isDisabled = _this$props16.isDisabled, isLoading = _this$props16.isLoading, isFocused = this.state.isFocused;
    if (!LoadingIndicator || !isLoading) return null;
    return React__default.createElement(LoadingIndicator, _extends$3({}, commonProps, {
      innerProps: {
        "aria-hidden": "true"
      },
      isDisabled: isDisabled,
    ...
    return React__default.createElement(IndicatorSeparator, _extends$3({}, commonProps, {
      isDisabled: isDisabled,
      isFocused: isFocused
    }));
    ...
    return React__default.createElement(DropdownIndicator, _extends$3({}, commonProps, {
      innerProps: innerProps,
      isDisabled: isDisabled,
      isFocused: isFocused
    }));
  }, _proto.renderMenu = function() {
    var _this5 = this, _this$components3 = this.components, Group = _this$components3.Group, GroupHeading = _this$components3.GroupHeading, Menu = _this$components3.Menu, MenuList = _this$components3.MenuList, MenuPortal = _this$components3.MenuPortal, LoadingMessage = _this$components3.LoadingMessage, NoOptionsMessage = _this$components3.NoOptionsMessage, Option = _this$components3.Option, commonProps = this.commonProps, _this$state8 = this.state, focusedOption = _this$state8.focusedOption, menuOptions = _this$state8.menuOptions, _this$props17 = this.props, captureMenuScroll = _this$props17.captureMenuScroll, inputValue = _this$props17.inputValue, isLoading = _this$props17.isLoading, loadingMessage = _this$props17.loadingMessage, minMenuHeight = _this$props17.minMenuHeight, maxMenuHeight = _this$props17.maxMenuHeight, menuIsOpen = _this$props17.menuIsOpen, menuPlacement = _this$props17.menuPlacement, menuPosition = _this$props17.menuPosition, menuPortalTarget = _this$props17.menuPortalTarget, menuShouldBlockScroll = _this$props17.menuShouldBlockScroll, menuShouldScrollIntoView = _this$props17.menuShouldScrollIntoView, noOptionsMessage = _this$props17.noOptionsMessage, onMenuScrollToTop = _this$props17.onMenuScrollToTop, onMenuScrollToBottom = _this$props17.onMenuScrollToBottom;
    if (!menuIsOpen) return null;
    var menuUI, render = function(props) {
      var isFocused = focusedOption === props.data;
      return props.innerRef = isFocused ? _this5.getFocusedOptionRef : void 0, React__default.createElement(Option, _extends$3({}, commonProps, props, {
        isFocused: isFocused
    ...
    if (this.hasOptions()) menuUI = menuOptions.render.map((function(item) {
      if ("group" === item.type) {
        ...
        return React__default.createElement(Group, _extends$3({}, commonProps, group, {
    ...
    var menuPlacementProps = {
    ...
    }, menuElement = React__default.createElement(index.MenuPlacer, _extends$3({}, commonProps, menuPlacementProps), (function(_ref6) {
      ...
      return React__default.createElement(Menu, _extends$3({}, commonProps, menuPlacementProps, {
        innerRef: ref,
        innerProps: {
      ...
      }, React__default.createElement(MenuList, _extends$3({}, commonProps, {
        innerRef: _this5.getMenuListRef,
        isLoading: isLoading,
        maxHeight: maxHeight
      }), menuUI))));
    }));
    return menuPortalTarget || "fixed" === menuPosition ? React__default.createElement(MenuPortal, _extends$3({}, commonProps, {
    ...
    var _this6 = this, _this$props18 = this.props, delimiter = _this$props18.delimiter, isDisabled = _this$props18.isDisabled, isMulti = _this$props18.isMulti, name = _this$props18.name, selectValue = this.state.selectValue;
    if (name && !isDisabled) {
      if (isMulti) {
        if (delimiter) {
    ...
    var _this$components4 = this.components, Control = _this$components4.Control, IndicatorsContainer = _this$components4.IndicatorsContainer, SelectContainer = _this$components4.SelectContainer, ValueContainer = _this$components4.ValueContainer, _this$props19 = this.props, className = _this$props19.className, id = _this$props19.id, isDisabled = _this$props19.isDisabled, menuIsOpen = _this$props19.menuIsOpen, isFocused = this.state.isFocused, commonProps = this.commonProps = this.getCommonProps();
    return React__default.createElement(SelectContainer, _extends$3({}, commonProps, {
      className: className,
      innerProps: {
        id: id,
      ...
      isDisabled: isDisabled,
      isFocused: isFocused
    }), React__default.createElement(Control, _extends$3({}, commonProps, {
    ...
    }), React__default.createElement(ValueContainer, _extends$3({}, commonProps, {
      isDisabled: isDisabled
    }), this.renderPlaceholderOrValue(), this.renderInput()), React__default.createElement(IndicatorsContainer, _extends$3({}, commonProps, {
      isDisabled: isDisabled
